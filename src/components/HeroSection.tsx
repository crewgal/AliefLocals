  ...
  return (
    <section className="relative min-h-[60vh] sm:min-h-[80vh] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        <img src={heroImg} alt="Aerial view of Alief, Texas" className="w-full h-full object-cover" />
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center px-4 sm:px-6 py-12 sm:py-20">
        ...
        >
          {t("Discover The Best Local")}{" "}
          <span className="text-primary">{t("Businesses in Alief")}</span>{" "}
          {t("and Surrounding Areas in Texas")}
        </motion.h1>
        ...
        >
          {t("For those of us who appreciate our local, hardworking friends and families right here in the 77083.")}
        </motion.p>
        ...
        >
          ...
          <input
            type="text"
            placeholder={t("Find a mechanic, dentist, or church...")}
        ...
        >
          <p className="text-white/60 text-xs sm:text-sm mb-3">{t("Follow us on social media")}</p>
